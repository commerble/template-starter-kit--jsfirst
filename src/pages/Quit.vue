                ...
                <form :action="action" method="post">
                    ...
                    <div>
                        <label class="checkbox">
                            <input type="checkbox" name="accept" value="true" required> 了承
                        </label>
                    </div>

                    <a class="button" :href="memberUrl">いいえ</a>
                    <button class="button is-danger" type="submit" name="update" value="update">はい、退会します。</button>
                </form>
            </div>
        </div>
    </main>
